...
import ProductsTopFilters from './blocks/Shop/ProductsTopFilters.vue';
import ProductsSideFilters from './blocks/Shop/ProductsSideFilters.vue';
import ProductsGrid from './blocks/Shop/ProductsGrid.vue';

const { state, handlePageClick, handleChangeSort, handleChangeSearch, handleGetFilters } =
  useProducts();
  ...
  <div class="bg-[#F6F6F6] min-h-screen flex flex-col">
    <div class="container mx-auto py-6 flex flex-col gap-6 min-h-screen">
      <div class="w-full flex items-center justify-between">
        <Search :modelValue="state.search" @update:modelValue="handleChangeSearch" class="w-1/5" />
